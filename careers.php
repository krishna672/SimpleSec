                    ...
                    <div class="caster-portfolio-wrap">
                        ...
                        <div id="widget-portfolio-container-grid"
                            ...
                            <div class="cbp-item  identity">
                                <a class="cbp-caption" href="contact.php">
                                    <div class="cbp-caption">
                                        <div class="cbp-caption-defaultWrap">
                                            <img width="600" height="560" src="data:image/gif;base64,R0lGODlhAQABAPAAAP///////yH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                 data-cbp-src="assets/images/dev.svg" alt="Image" />
                                        </div>
                                    </div> 
                                    <div class="cbp-l-grid-agency-title alignLeft">UI/UX Design</div>
                                    <div class="cbp-l-grid-agency-desc alignLeft">Internship</div>
                                    <div class="view-project">Apply</div>
                                </a>
                            </div>
                            ...
                            <div class="cbp-item  identity">
                                <a class="cbp-caption" href="contact.php">
                                    <div class="cbp-caption">
                                        <div class="cbp-caption-defaultWrap">
                                            <img width="600" height="500" src="data:image/gif;base64,R0lGODlhAQABAPAAAP///////yH5BAAAAAAALAAAAAABAAEAAAICRAEAOw=="
                                                 data-cbp-src="assets/images/ui.svg" alt="Image" />
                                        </div>
                                    </div>
                                    <div class="cbp-l-grid-agency-title alignLeft">Web Developer</div>
                                    <div class="cbp-l-grid-agency-desc alignLeft">Internship</div>
                                    <div class="view-project">Apply</div>
                                </a>
                            </div>
                ...
                <div class="container">
                    ...
                    <nav class="footer-socials" role="navigation" aria-label="Footer Social Links Menu">
                        ...
                        <ul id="social-media-footer" class="social-links-menu">
                            <li>
                                <a target="_blank" href="https://www.instagram.com/_simplesec_">
                                    <span>In</span>
                                    <i class="fab fa-instagram"></i>
                                </a>
                            </li>
                            <li>
                                <a target="_blank" href="https://www.linkedin.com/company/simplesecss/">
                                    <span>Li</span>
                    ...
                    <div class="site-info">
                        <p class="copyright">© 2020 SimpleSec </p>
                    </div><!-- .site-info -->
